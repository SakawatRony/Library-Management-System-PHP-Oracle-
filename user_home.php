    ...
    <body>
        ...
        <div class="row">
            <div class="col-12 d-flex justify-content-center col-sm-12 col-md-4">
                <div class="d-flex flex-column justify-content-center align-items-center cls_admin_button_div"> <a class="btn btn-primary btn-block d-flex flex-column justify-content-center align-items-center icon-button" role="button" href="available_booklist.php" data-bs-hover-animate="pulse" style="background-color: rgb(14,58,105);margin-top: 0px;"><i class="fa fa-eye d-flex" style="font-size: 26px;"></i><span class="d-flex"> Book List </span></a>
                </div>
            </div>
            <div class="col-12 d-flex justify-content-center col-sm-12 col-md-4">
                <div class="d-flex justify-content-center align-items-center cls_admin_button_div"><a class="btn btn-primary btn-block d-flex flex-column justify-content-center align-items-center icon-button" role="button" href="issued_book.php" data-bs-hover-animate="pulse" style="background-color: rgb(14,58,105);margin-top: 0px;"><i class="fa fa-eye d-flex" style="font-size: 26px;"></i><span class="d-flex"> Issued Book </span></a>
                </div>
            </div>
            <div class="col-12 d-flex justify-content-center col-sm-12 col-md-4">
